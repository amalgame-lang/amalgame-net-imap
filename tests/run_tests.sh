...
BUILD_DIR="$(mktemp -d -t ani-tests-XXXXXX)"
...
check "[PASS] greeting"
check "[PASS] capability"
check "[PASS] login refused pre-tls"
check "[PASS] login success"
check "[PASS] login failure"
check "[PASS] list"
check "[PASS] select"
check "[PASS] fetch body"
check "[PASS] uid fetch"
check "[PASS] store flags"
check "[PASS] search all"
